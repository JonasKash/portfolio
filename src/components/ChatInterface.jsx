...
const ChatInterface = ({ 
  ...
  // Audio refs and playSound function removed

  // useEffect for open sound removed
  ...
  const handleSendMessage = async () => {
    ...
    setInputMessage("");
    // playSound(sendAudioRef); // Removed sound playback
  ...
  const handleAgentResponse = (response) => {
    ...
    setTimeout(() => {
      ...
      setMessages((prev) => [...prev, newMessage]);
      // playSound(receiveAudioRef); // Removed sound playback
    }, typingDelay);
  };

  // Handle chat close - Reverted to original behavior
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Preload audio elements removed */}
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-800 bg-gradient-to-r from-gray-900 to-black">
        ...
        <button
          onClick={handleCloseChat} // Use the reverted handler for closing
